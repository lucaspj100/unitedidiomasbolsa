...
ALTER TABLE public.leads ADD COLUMN IF NOT EXISTS alinhamento_financeiro text;
...
BEGIN
  ...
  IF p_id IS NULL THEN
    INSERT INTO public.leads (
      ...
      motivo_nao_faz_curso, alinhamento_financeiro, decisao_entrevista, classificacao_lead,
